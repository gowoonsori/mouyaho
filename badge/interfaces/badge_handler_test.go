...
func Test_GetLikeBadge_Handler_Basic_Success(t *testing.T) {
	...
	bs := initMockService()
	bs.On("GetBadgeFile", userId, baseUrl+apiUrl).Return([]byte(strings.TrimSpace(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="99" height="30">
