...
var heartsTemplate = strings.TrimSpace(`
<html lang="en">
<head>
    <title>likeIt</title>
    <style>
        ...
        .badge-container .badge-box {border: 2px solid {{.BorderColor}};box-shadow: 0 0 1px 1px #bfbfbf; display: inline-block;padding: 5px 20px; border-radius: 25px}
